...
<template>
  <div id="notfound">
    ...
    <router-link to="/" v-slot="{navigate, isActive }" >  
      <a :active="isActive" @click="navigate">Go To Homepage</a>
    </router-link>
